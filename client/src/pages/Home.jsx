                    ...
                    <div className="flex flex-col justify-center items-center " >
                        {
                            Cookie.get('profile')
                                ?
                                <button onClick={logoutFunc} className="capitalize text-[16px] rounded-[4px] bg-white px-[16px] py-[8px] text-black " >logout</button>
                                :
                                <p className="capitalize text-[24px] text-black">Home Page</p>
                            }
