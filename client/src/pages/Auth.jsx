...
const Auth = () => {
  ...
  const handleChangePassword = () => {
    if (!changePasswordValidated) return null
      ...
      {isLoading ? (
        ...
        <>
          {user ? (
            ...
            <div className="flex flex-col justify-center items-center w-[22rem] bg-white gap-[1rem] rounded-[4px] p-[1rem] border-[1px] border-white">
              {page === 'register' && (
                <div className="flex flex-col justify-between items-center gap-[1rem] w-full">
                  ...
                  <div className="flex flex-col gap-[2rem] w-full">
                    <Input attribute="name" type="text" placeholder="Name..." blurFunction={nameBlur} />
                    <Input attribute="email" type="email" placeholder="Email..." blurFunction={emailBlur} />
                    <Input attribute="password" type="password" placeholder="Password..." blurFunction={passwordBlur} showEyeIcon />
                    <Input attribute="confirmPassword" type="password" placeholder="Confirm Password..." blurFunction={confirmPasswordBlur} showEyeIcon />
                  </div>
                  <div className="flex flex-col items-center w-full gap-[2rem]">
                    <div style={{ width: '100%' }} className="flex flex-col items-center gap-[8px] w-full">
                      ...
                      <p>
                        ...
                        <span onClick={() => setPage('login')} className="underline cursor-pointer text-linkBlue">login here</span>
                      </p>
                    </div>
                  </div>
              ...
              {page === 'register_otp' && (
                <div className="flex flex-col justify-start gap-[1rem] w-full">
                  <div className="flex flex-col gap-[2rem] w-full">
                    <p>We have sent a verification code to email {userFormData.email}. Enter the code here</p>
                    <Input attribute="registerOTP" type="text" placeholder="Verification Code" />
                  </div>
                  <div className="flex flex-col items-center w-full gap-[2rem]">
                  ...
                  {errorObj.register && (
                    <p className="text-red text-[14px] capitalize">
                      {errorObj.register}
                      <span onClick={handleSendRegisterOTP} className="text-linkBlue cursor-pointer text-[16px] ml-[8px]">Resend</span>
                    </p>
                  )}
                </div>
              )}
              ...
              {page === 'login' && (
                <div className="flex flex-col justify-between items-center gap-[1rem] w-full">
                  ...
                  <div className="flex flex-col items-center w-full gap-[8px]">
                    ...
                    <p>
                      Don't have account.{' '}
                      <span onClick={() => setPage('register')} className="underline cursor-pointer text-linkBlue">create account</span>
                    </p>
                  </div>
                  {errorObj.login && <p className="text-red text-[14px]">{errorObj.login}</p>}
                </div>
              )}
              ...
              {page === 'forget_password_email' && (
                <div className="flex flex-col justify-start gap-[1rem] w-full">
                  ...
                  {errorObj.sendForgetPasswordOTP && <p className="text-red text-[14px]">{errorObj.sendForgetPasswordOTP}</p>}
                </div>
              )}
              ...
              {page === 'forget_password_otp' && (
                <div className="flex flex-col justify-start gap-[1rem] w-full">
                  <div className="flex flex-col gap-[2rem] w-full">
                    <p>We have sent a verification code to email {userFormData.email}. Enter the code here</p>
                    <Input attribute="forgetPasswordOTP" type="text" placeholder="Verification Code" />
                    <Input attribute="password" type="password" placeholder="New Password..." blurFunction={passwordBlur} showEyeIcon />
                  </div>
                  <div className="flex flex-col items-center w-full gap-[2rem]">
                  ...
                  {errorObj.changePassword && (
                    <p className="text-red text-[14px] capitalize">
                      {errorObj.changePassword}
                      <span onClick={handleSendForgetPasswordOTP} className="text-linkBlue cursor-pointer text-[16px] ml-[8px]">Resend</span>
                    </p>
                  )}
                </div>
              )}
